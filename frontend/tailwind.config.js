  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-pattern': "url('https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=2000&q=80')",
        'dots-pattern': "radial-gradient(circle, #f97316 1px, transparent 1px)"
      },
      backdropBlur: {
        xs: '2px'
      }
